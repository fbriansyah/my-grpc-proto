...
import (
	...
	extHello "github.com/fbriansyah/my-grpc-proto/protogen/go/hello"
...
func request_HelloService_SayManyHello_0(ctx context.Context, marshaler runtime.Marshaler, client extHello.HelloServiceClient, req *http.Request, pathParams map[string]string) (extHello.HelloService_SayManyHelloClient, runtime.ServerMetadata, error) {
	var protoReq extHello.HelloRequest
	var metadata runtime.ServerMetadata
	...
	stream, err := client.SayManyHello(ctx, &protoReq)
	if err != nil {
...
func RegisterHelloServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extHello.HelloServiceServer) error {
	...
	mux.Handle("POST", pattern_HelloService_SayManyHello_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterHelloServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extHello.HelloServiceClient) error {
	...
	mux.Handle("POST", pattern_HelloService_SayManyHello_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/hello.HelloService/SayManyHello", runtime.WithHTTPPathPattern("/hello.HelloService/SayManyHello"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_HelloService_SayManyHello_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_HelloService_SayManyHello_0(annotatedContext, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	...
	pattern_HelloService_SayManyHello_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"hello.HelloService", "SayManyHello"}, ""))
...
var (
	...
	forward_HelloService_SayManyHello_0 = runtime.ForwardResponseStream
